...
pickle_file = open(r'C:\Users\tanvi\Desktop\intern\Fitness_enquiry_chatbot-1\FINAL_DATA.pickle', 'rb')
data = pickle.load(pickle_file)
le = pickle.load(pickle_file)
tokenizer = pickle.load(pickle_file)

# Load model that was created with chatbot_train_model.py.
model = tf.keras.models.load_model(r"C:\Users\tanvi\Desktop\intern\Fitness_enquiry_chatbot-1\FINAL_MODEL.h5")
...
def process_query(string):
    ...
    if prediction[max_prediction_value_index] > 0.8:
        ...
        return "Sorry, I don't understand what you mean. Please ask a approppriate question"